	...
	protected void drawText(Batch batch, BitmapFont font, float x, float y)
	{
		...
		if (hasKeyboardFocus() && hasSelection && cursor != selectionStart)
		{
			...
			if (colorMarkupDisplayText.equals("") || prevCursor != cursor || prevSelectionStart != selectionStart)
			{
				...
				colorMarkupDisplayTextBuilder.insert(Math.min(cursor, selectionStart), "[#" + (style.selectionFontColor == null ? style.fontColor.toString() : style.selectionFontColor.toString()) + "]");
